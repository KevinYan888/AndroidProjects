...
public class TriviaToolbar extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, BottomNavigationView.OnNavigationItemSelectedListener  {
...
//                startActivity(goToChat);
            ...
            case R.id.item2:
                message = "Go to play";
                Intent goToActivity = new Intent(TriviaToolbar.this, TriviaActivity.class);
